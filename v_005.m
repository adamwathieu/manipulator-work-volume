...
%
%DESCRIPTION
%This is seventh program written for the project. This program attempts to 
%compute the largest diameter of a circular object which would fit in the 
%SDH. This program is not fully functional, and its objective could be 
%better met with further work on the MatLab application, where a user could
%import a shape onto the plot, and wrap the hands around the shape to see 
%if it fits.
